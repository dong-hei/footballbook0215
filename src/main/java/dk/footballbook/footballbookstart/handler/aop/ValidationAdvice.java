package dk.footballbook.footballbookstart.handler.aop;
...
public class ValidationAdvice {
    ...
    @Around("execution(* com.cos.footballbookstart.web.api.*Controller.*(..))")
        ...
        for (Object arg : args) {
            if (arg instanceof BindingResult) {
                ...
                if (bindingResult.hasErrors()) {
                    ...
                    throw new CustomValidationApiEx("유효성 검사 실패함", errorMap);
                }
    ...
    @Around("execution(* com.dk.footballbookstart.web.*Controller.*(..))")
        ...
        for (Object arg : args) {
            if (arg instanceof BindingResult) {
                ...
                if (bindingResult.hasErrors()) {
                    ...
                    throw new CustomValidationEx("유효성 검사 실패함", errorMap);
                }
            }
        }
